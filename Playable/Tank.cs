...
public class Tank : PlayableC
{
    ...
    override public void Skill3(Transform trans) //땅울리기. >>모든 몬스터에게 공격력만큼의 데미지를 주고 방어력을 3씩 감소시킴.
    { //>> 높은 가치의 스킬이기에 코스트 높게 설정할것.
        ...
        for (int i=0; i<CombatManager.Instance.monsterAliveList.Count; i++)
        {
            ...
            CombatManager.Instance.monsterAliveList[i].GetComponent<TestMob>().Def -= 3;
