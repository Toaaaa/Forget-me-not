...
public class TextManager : MonoBehaviour
{
    ...
    void GenerateData()//이곳에 대화 데이터들 입력
    {
        ...
        {
            "차원이동 마법 이론 _ 저자 이슈탈튼 비썬더",
            "차원이동 마법의 경우 시전 자체만으로도 많은 인과를 비트는 행위이며 이는 마법의 재능뿐만 아니라 높은 수준의 '시전자의 격' 을 요구하며",
            "차원이동을 시전하기전 해당 차원에 '심리안'을 통해 해당 차원의 도착지점의 좌표 및 마력고리를 고정할 필요가 있다. ",
            "그리고 다음 장에서 설명하게될 방법을 통해 차원문을 열어 이동을 하는 방식으로 작은틀에 있어서의 차원이동을 행할수 있다.",
            "하지만 해당 '차원이동' 이라는 행위에 있어서는 인과율 과 더불어 많은 부작용이 따를수 있다",
            "간단하게는 차원이 충돌하는 지점의 주변에 '마력의 격'이 떨어지는 지적 생명체가 있을경우 생명체에 치명적인 부작용을 불러올 수 있으며 ",
            "또한 너무 오랜기간 두 차원이 연결되어 있을경우 '마력의 총량'이 떨어지는 한쪽이 차원이 다른 차원에 흡수되는 사고가 있어날 수 있다.",
            "(해당 사고에 대해서는 4장의 '차원이동 시동조건' 에서 다루도록 하겠다.)",
        });//2스테이지 도서관의 책 3
    ...
    void GenerateStoryData()
    {
        ...
        storyTalkData.Add(3000, new string[] 
        {
            ...
            "죽어도 죽지 못하는 존재가 되었고 이것이 원인이 되어, 제가 있던 차원에 수백년간 의 불사의 인과율이 쌓이게 되었고 :4:고양이 :0",
            "세계가 인과율을 감당하기 위해서 무리하게 확장을 하는 과정중 해당 차원을 침범하게 되었습니다.:4:고양이:0",
        ...
        storyTalkData.Add(6000, new string[] //1-2에서 타일 트리거
        {
            ...
            "고블린 무리? 살짝 무서워지는걸..:0:나:0",
            "혹시 고블린들이 물건을 어디에 보관하고 있는지 알고계신가요? :4:고양이:0",
            "기본적으로 숨어 지내는 몬스터 들이지만, 저번에 굴 안쪽 깊은곳의 어떤 동굴 같은곳에 접근하려 하니, 매우 경계했어. :8:견습 기사:0",
            "아마도 그곳에 물건을 보관한게 아닐까 싶다. :8:견습 기사:0",
            "그렇다면 저희는 그쪽으로 가야 할것 같은데, 기사님은 어떻게 하시겠어요? :4:고양이:0",
            "일이 다 끝나고 이곳에서 바로 나갈수 있다면 나야 기꺼이 돕지. :8:견습 기사:12",//파티에 기사 추가
            "애초에 기사 수행이 목적이라 이후의 계획도 크게 없고 정처없이 떠돌아 다닐 뿐이니깐. :8:견습 기사:0",
            "그렇다면 한동안 저희들과 함께 하실래요? 저희도 여러지역을 돌아 다닐것 같아요 :4:고양이:1",//암전 효과
            "그래. 그러도록 하지. :8:견습 기사:0",
        });
        storyTalkData.Add(7000, new string[] //1-5에서 타일 트리거
        {
            "저곳이 그곳이야. 숨어서 지키는 고블린이 있는지 근처에 다가가면 금방 경계태세를 취했어.:8:견습 기사:0",
            "주변에 딱히 적은 안보이는데.:0:나:0",
            "싸움이 시작되면 어딘가에 숨어있던 고블린들이 줄줄이 나와서 긴장해야해.:8:견습 기사:0",
            "그렇다면 빠르게 전투를 끝내는게 제일 중요할 것 같네요:4:고양이:0",
            "전투라면 맡겨줘, 견습 기사라고는 하나 이름 있는 기사가문의 소속이다. 실망시키는 일은 없도록 하지.:8:견습 기사:0",
            "잘 부탁 드릴게요:4:고양이:0",
        });
        storyTalkData.Add(8000, new string[] //1-6입장시 출력
        {
            ...
            "으악! 저건또 뭐야!:10:견습 기사:5", //카메라 무빙으로 고블린 엘더 보여줌 (카메라 무빙 + 카메라 무빙 해주는 4번이 아닌 스크립트 번호 제작.)
            "곰이야? 살면서 처음보는 괴물인데??.:8:견습 기사:7", //다시 카메라 주인공으로 바로 리턴
            "고블린들은 강한자라면 누구든 족장의 자리를 얻을수 있다고 하던데, 정말이였잖아.:8:견습 기사:0",
            "나 죽는거 아니겠지..?:1:나:0",
        ...
        storyTalkData.Add(9000, new string[] //1-6에서 타일 트리거
        {
            ...
            ".....:0:나:14", //칼로 동상을 베는 효과 + 동상이 베여서 쓰러지는 애니메이션 + 페이드 아웃으로 동상이 사라지며 비활성화
            "이게 끝이야?:0:나:0",
            ...
            "이곳에서 할 일이 다 끝났으면 일단 이곳에서 나가지.:10:견습 기사:0",
        ...
        storyTalkData.Add(10000, new string[]//스테이지 2 입장시(입구의 타일을 밟으면) 출력 + isOnStage2
        {
            ...
            "아! 그리고 눈이 쌓여있고 바람도 험해서 이동이 조금 불편해 질거에요.:12:마법사:0",
        ...
        storyTalkData.Add(11000, new string[]//마을에 도착(타일) 하면 출력 + checkpoint1
        {
            ...
            "(견습 기사가 파티에서 이탈 하였습니다) :8:견습 기사:13",//파티에 기사 이탈
        ...
        storyTalkData.Add(15000, new string[]//마을에서 오른쪽 출구로 나오며 + checkpoint5
        {
            ...
            "저는 괜찮아요, 마법으로 어느정도 온도가 유지 가능하거든요.:12:마법사:0",
        ...
        storyTalkData.Add(31000, new string[]//스테이지 2의 메인스토리가 끝난뒤 장로에게 다시 말을 걸 경우
        {
            "정말 감사드립니다 용사님들.:21:에랄드:0",
        });//(반복)
        ...
        for (int i = 0; i < 22; i++)
        {
            ...
            storyPortraitData.Add(31000 + i, storyArr[i]);
        }//0번 스테이지 초상화.
    }
