...
public class TextManager : MonoBehaviour
{
    ...
    void GenerateStoryData()//이곳에 스토리 데이터들 입력
    {
        ...
        storyTalkData.Add(8000, new string[]
        {
            ...
            "으악! 엘더 고블린이다!:8:견습 기사:4", //카메라 무빙으로 고블린 엘더 보여줌 (카메라 무빙 + 카메라 무빙 해주는 4번이 아닌 스크립트 번호 제작.)
            "저녀석 무지막지하게 강하다고 들었어.:8:견습 기사:0", //다시 카메라 주인공으로 바로 리턴
            "고블린들 중에서 가장 강한 전투력을 가진 녀석이 족장 비슷한 것으로 추앙 받는다고 하던데.:8:견습 기사:0",
            "그워어어어어!!!:16:엘더 고블린:4", //카메라 무빙으로 고블린 엘더 보여줌
            "온다! 조심해!:0:나:0" //다시 카메라 주인공으로 바로 리턴
        });
        storyTalkData.Add(9000, new string[]
        {
            ...
            "그럼 이제 이곳에서 나가자.:10:견습 기사:0",
            "하수구 냄새때문에 속이 안좋아...:10:견습 기사:0", //stage1complete 세팅하기.
        });
